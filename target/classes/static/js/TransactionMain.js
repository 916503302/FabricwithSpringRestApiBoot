...
function getData() {  //获取数据
    ...
    dataGet = [
        [1, 0, 0, 0], [myShiftDateA[0], 1, 8, transactionid[0], parentorder[0], suborder[0], payid[0], transtype[0], fromtype[0], fromid[0], totype[0], toid[0], productid[0], productinfo[0], organizationid[0], amount[0], price[0]], [3, 2, 6, 9], [5, 3, 6, 1], [1, 4, 0, 0]

            [1, 0, 0, 0], [myShiftDateA[1], 1, 8, transactionid[1], parentorder[1], suborder[1], payid[1], transtype[1], fromtype[1], fromid[1], totype[1], toid[1], productid[1], productinfo[1], organizationid[1], amount[1], price[1]], [4, 2, 6, 8], [7, 3, 6, 33], [2, 4, 0, 0]
            ...
            [4, 0, 0, 0], [myShiftDateA[4], 1, 8, transactionid[4], parentorder[4], suborder[4], payid[4], transtype[4], fromtype[4], fromid[4], totype[4], toid[4], productid[4], productinfo[4], organizationid[4], amount[4], price[4]], [7, 2, 6, 6], [19, 3, 6, 8888], [0, 4, 0, 0]
    ];
